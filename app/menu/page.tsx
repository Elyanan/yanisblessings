      ...
      <section className="sticky top-16 md:top-20 z-40 bg-background border-b border-border shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col md:flex-row md:items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-2 overflow-x-auto pb-1" role="group" aria-label={t('menu.filters')}>
          ...
          {showFilters && (
            <div id="mobile-category-filters" className="md:hidden flex flex-wrap gap-2 mt-4 pt-4 border-t border-border">
              {categories.map((category) => (
                <button
                  type="button"
                  key={category.id}
