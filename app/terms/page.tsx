...
export const metadata: Metadata = {
  ...
  description,
  alternates: { canonical: `${policySite.url}/terms` },
  openGraph: {
    title: `${title} | ${policySite.name}`,
    description,
    url: `${policySite.url}/terms`,
    type: 'website',
  },
}
  ...
  return (
    <PolicyLayout title={title} description={description} jsonLd={jsonLd}>
      ...
      <PolicySection id="payment" title="Payment Terms">
        ...
        <ul>
          <li><strong>Cash on Delivery (COD)</strong> — pay when you receive your order, where offered.</li>
